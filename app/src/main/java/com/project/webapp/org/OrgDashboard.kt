package com.project.webapp.org
...
@Composable
fun OrgDashboard(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel) {
    ...
    Column(
        ...
        TopBar()
        Text(text = "Organization Dashboard")
